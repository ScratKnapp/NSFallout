...
local WHITE = Color(0, 238, 0, 150)--Color(255, 255, 255, 150)
local SELECTED = Color(0, 238, 0, 230)

PANEL.WHITE = WHITE
PANEL.SELECTED = SELECTED
PANEL.HOVERED = Color(0, 238, 0, 50)
...
function PANEL:createTitle()
	...
	self.title:SetText("")
	self.title:SetTextColor(Color(0, 238, 0, 255))
	...
	self.desc:SetTextColor(Color(0, 238, 0, 255))
end
