...
--swaps player with an npc (kills if no npc)
nut.command.add("hellholeswap", {
	adminOnly = true,
	syntax = "<string name>",
...
--teleports player to aim pos
nut.command.add("hellholetp", {
	adminOnly = true,
	syntax = "<string name>",
	onRun = function(client, arguments)
...
--spawns effect at aim pos and summons npcs
