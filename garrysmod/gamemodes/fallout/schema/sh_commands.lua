nut.command.add("roll", {
	...
	onRun = function(client, arguments)
		local rolled
		if(client.rollLoaded) then
			rolled = client.rollLoaded
			client.rollLoaded = nil
		else
			rolled = math.random(0, math.min(tonumber(arguments[1]) or 100, 100))
		end
...
if(CLIENT) then
	netstream.Hook("idReq", function(text)
