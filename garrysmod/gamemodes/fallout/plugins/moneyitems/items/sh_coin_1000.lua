ITEM.name = "Credits (1000)"
ITEM.desc = "A heavy tin with a large number of caps inside."
ITEM.uniqueID = "coin_1000"
...
if (CLIENT) then
	function ITEM:paintOver(item, w, h)
		draw.SimpleText(item.value, "DermaDefault", w - 24, h - 14, Color(125,125,125), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP, 1, color_black)
	end
end