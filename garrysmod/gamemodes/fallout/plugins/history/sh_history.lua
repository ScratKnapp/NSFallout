...
HISTORY.func = function(client, character)
	...
	character:updateSkill("repair", 20)
end
HISTORIES:Register(HISTORY)
...
HISTORY.func = function(client, character)
	...
	character:updateSkill("science", 20)
end
HISTORIES:Register(HISTORY)
...
HISTORY.func = function(client, character)
	...
	character:updateSkill("survival", 20)
end
HISTORIES:Register(HISTORY)