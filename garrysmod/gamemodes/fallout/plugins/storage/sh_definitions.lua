--[[
	STORAGE_DEFINITIONS[model's name(lowercase)] = {
		name = "Crate",
...
STORAGE_DEFINITIONS["models/props_c17/furniturewashingmachine001a.mdl"] = {
...
STORAGE_DEFINITIONS["models/props/cs_militia/dryer.mdl"] = {
	name = "Drying Machine",
...
STORAGE_DEFINITIONS["models/props/cs_militia/gun_cabinet.mdl"] = {
	name = "Gun Cabinet",
...
STORAGE_DEFINITIONS["models/props_interiors/furniture_vanity01a.mdl"] = {
	name = "Vanity",
...
STORAGE_DEFINITIONS["models/props_interiors/furniture_desk01a.mdl"] = {
	name = "Desk",
	desc = "A wooden desk.",
	invData = {
		w = 3,
...
STORAGE_DEFINITIONS["models/props_c17/furnituredrawer003a.mdl"] = {
	name = "Drawer",
	desc = "A wooden drawer.",
	invData = {
		w = 1,
...
STORAGE_DEFINITIONS["models/props_c17/oildrum001.mdl"] = {
	name = "Barrel",
	desc = "A metal barrel.",
	invData = {
		w = 2,
...
STORAGE_DEFINITIONS["models/props/cs_office/file_cabinet1_group.mdl"] = {
	name = "File Cabinets",
...
STORAGE_DEFINITIONS["models/props/cs_office/file_cabinet1.mdl"] = {
	name = "File Cabinet",
	desc = "A metal file cabinet.",
	invData = {
		w = 2,
...
STORAGE_DEFINITIONS["models/props_junk/plasticbucket001a.mdl"] = {
	name = "Bucket",
...
STORAGE_DEFINITIONS["models/props_junk/metal_paintcan001a.mdl"] = {
	name = "Paint Bucket",
...
STORAGE_DEFINITIONS["models/props_lab/jar01a.mdl"] = {
	name = "Jar",
	desc = "A jar.",
	invData = {
		w = 1,
...
STORAGE_DEFINITIONS["models/props_lab/partsbin01.mdl"] = {
	name = "Cabinet",
...
STORAGE_DEFINITIONS["models/props/cs_office/trash_can.mdl"] = {
	name = "Trash Can",
	desc = "A plastic trash bin.",
	invData = {
		w = 2,
...
STORAGE_DEFINITIONS["models/props_junk/trashdumpster01a.mdl"] = {
	name = "Dumpster",
...
--this is from PAC gear.
STORAGE_DEFINITIONS["models/warz/items/lockbox.mdl"] = {
	name = "Small Safe",
...
--here comes the fantasy things
STORAGE_DEFINITIONS["models/props/furnitures/humans/chests/rich_chest_01.mdl"] = {
	name = "Fancy Chest",
	desc = "A fancy looking chest.",
	invData = {
		w = 6,
		h = 4
	},	
...
STORAGE_DEFINITIONS["models/props/furnitures/humans/chests/rich_chest_01_dirty.mdl"] = {
	name = "Fancy Chest",
	desc = "A fancy looking chest.",
	invData = {
		w = 6,
...
STORAGE_DEFINITIONS["models/props/furnitures/gob/l6_crate_01/l6_crate_01.mdl"] = {
	name = "Wooden Crate",
...
STORAGE_DEFINITIONS["models/props/tools/humans/crates/crateb_new.mdl"] = {
	name = "Massive Crate",
	desc = "A massive wooden crate",
	invData = {
		w = 10,
		h = 5
	},	
...
STORAGE_DEFINITIONS["models/immigrant/witcher3props/woodenchest.mdl"] = {
	name = "Wooden Chest",
	desc = "A regular wooden chest.",
	invData = {
		w = 5,
		h = 4
	},	
...
STORAGE_DEFINITIONS["models/immigrant/witcher3props3/container4.mdl"] = {
	name = "Wooden Box",
	desc = "A compact wooden box.",
	invData = {
		w = 3,
		h = 3
	},	
...
STORAGE_DEFINITIONS["models/immigrant/witcher3props3/barrel.mdl"] = {
	name = "Wooden Barrel",
	desc = "A nice wooden barrel.",
	invData = {
		w = 3,
		h = 5
	},	
