...
local function _IMPEL()
    ...
    if SERVER then AddCSLuaFile("cyr/modules/chat/cl_chat_html.lua") end
    includeModule("chat", "chat")
    includeModule("chat", "combat_log")
    ...
    includeModule("net", "net")
    includeModule("net", "html_templates")
    includeModule("net", "neoncities")
end
