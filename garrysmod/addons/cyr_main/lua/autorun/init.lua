...
local function _IMPEL()
    ...
    includeModule("chat", "chat_offset") -- vertical offset for nutChat + combat log (gamemode-agnostic)
    ...
    -- includeModule("ui", "dialogue_override") -- FNV-style talknpc dialogue panel (disabled)
end
